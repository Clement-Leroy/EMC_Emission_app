...
def suspectsTable_conducted(selectedRows, style, minimize_suspectTable_container_style):
...
def suspectsTable_radiated(selectedRows, style, minimize_suspectTable_container_style):
...
def finalsTable_conducted(selectedRows, style, minimize_finalTable_conducted_container_style):
...
def finalsTable_radiated(selectedRows, style, minimize_finalTable_radiated_container_style):
